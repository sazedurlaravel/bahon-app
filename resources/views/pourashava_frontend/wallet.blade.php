<x-user.app-layout>
    ...
    <x-slot name="header">
        <x-admin.content-header>
            ...
            <a onclick="wallet_form(' ই-ওয়ালেট', '{{ route('pourashava_frontend.user.wallet.request',$pourashava_slug) }}')" data-toggle="modal" data-target="#walletForm" href="#" class="btn btn-primary"> <i class="fas fa-plus mr-1"></i> রিকুয়েস্ট এড মানি </a>
        </x-admin.content-header>
    </x-slot>
