        ...
        <x-admin.content-header>
            <x-slot name="title">
                <h1> পৌরসভা তথ্য</h1>
                  ...
                  <a href="{{ route('admin.settings.pourashava_information.create') }}" class="btn btn-primary"> <i class="fas fa-plus mr-1"></i> নতুন পৌরসভা তথ্য</a>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                                        ...
                                        <a class="dropdown-item" href="{{ route('admin.settings.pourashava_information.edit', $information->id) }}"> এডিট </a>
                                        @endif
                                    </div>
                                </div>
                            </td>
