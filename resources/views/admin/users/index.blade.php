                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                                        <a class="dropdown-item" href="{{ route('admin.users.show', $user->id) }}"> বিস্তারিত </a>
                                        <a class="dropdown-item" href="{{ route('admin.users.card', $user->id) }}" target="_blank"> কার্ড </a>
                                        @can('edit_user')
                                            <a class="dropdown-item" href="{{ route('admin.users.edit', $user->id) }}"> এডিট </a>
                                        @endcan
                                    </div>
                                </div>
                            </td>
