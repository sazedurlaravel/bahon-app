            ...
            @endif
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="card_no" class="form-control @error('card_no') is-invalid @enderror" id="card_no" value="{{ old('card_no', isset($user) ? $user->card_no : '') }}" required>
                        @error('mobile')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="pin_no" class="form-control @error('pin_no') is-invalid @enderror" id="pin_no" value="{{ old('pin_no', isset($user) ? $user->pin_no : '') }}" required>
                        @error('pin_no')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
