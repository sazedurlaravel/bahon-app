    ...
    <div class="root_wrap">
        <div class="clearfix">
            <div class="box" style="width: 25%;">
                <img class="logo" src="{{asset('uploads/'.$user->pourashavaAdmin->pourashava_logo)}}" alt="Logo">
            </div>
            <div class="box" style="width: 35%;">
            <p style="color: white; font-size: 22px; padding-top: 15px;">{{ $user->pourashavaAdmin->name }}</p> 
            </div>
      ...
      <div class="clearfix">
            <div class="box" style="width: 33%;">
                <img class="picture" src="{{asset('uploads/'.$user->pourashavaAdmin->picture)}}" alt="Picture">
