<x-admin.app-layout>
    ...
    @endif
            ...
            @if (Request::routeIs('admin.business_holders.create'))
                <form action="{{ route('admin.business_holders.store') }}" method="post" enctype="multipart/form-data">
            @else
            @if (Storage::exists($user->picture))
                <img src="{{ Storage::url($user->picture) }}" class="img img-thumbnail mb-2" style="width: 100px;">
            @endif
                <form action="{{ route('admin.business_holders.update', $user) }}" method="post" enctype="multipart/form-data">
                    @method('put')
            @endif
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        @endif
                        <input type="file" name="picture" class="form-control @error('picture') is-invalid @enderror" id="picture" @if(Request::routeIs('admin.business_holders.create')) required @endif>
                        @error('picture')
