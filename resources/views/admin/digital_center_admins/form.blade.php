    ...
    <div class="card card-info">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-3">
                    <x-label for="email" :require="true"> পদবি </x-label> 
                    <input type="test" name="designation" class="form-control @error('email') is-invalid @enderror"
                        id="designation"
                        value="{{ old('designation', isset($digitalCenterAdmin) ? $digitalCenterAdmin->designation : '') }}"
                        required>
                    @error('designation')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
